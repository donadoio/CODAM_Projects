...
/*   Updated: 2021/03/04 23:20:50 by idonado       ########   odam.nl         */
/*                                                                            */
/* ************************************************************************** */
...
int main(void)
{
	...
	NinjaTrap Randy("Randy");
	NinjaTrap Brady("Brady");

	Randy.ninjaShoeBox(Brady);
	Randy.ninjaShoeBox(rufus);
	Randy.ninjaShoeBox(lilly);

	Randy.takeDamage(20);
	Randy.rangedAttack("Tiger");
	Randy.meleeAttack("Fooger");
