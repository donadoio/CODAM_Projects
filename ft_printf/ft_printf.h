...
t_data			switch_unegative(int *mwidth, t_data data);
...
t_data			p_ptr_star_dot(t_data data, va_list args);
t_data			p_ptr_ndn(const char *format, t_data data, va_list args);
