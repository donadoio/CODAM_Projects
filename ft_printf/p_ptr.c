...
static	t_data	p_ptr_nds(const char *format, t_data data, va_list args)
{
	t_vars vars;
...
static	t_data	p_ptr_sdn(const char *format, t_data data, va_list args)
{
	t_vars vars;
...
static	t_data	p_ptr_sds(t_data data, va_list args)
{
	t_vars vars;
...
static	t_data	check_ptr(const char *format, t_data data, va_list args)
{
	if (data.mwidth == true)
		...
		data = p_ptr_ndn(format, data, args);
	else if (data.num_dot_star == true)
		data = p_ptr_nds(format, data, args);
	return (data);
}
...
t_data			p_ptr(const char *format, t_data data, va_list args)
{
	...
	if (data.star_dot_num == true)
		data = p_ptr_sdn(format, data, args);
	else if (data.star_dot_star == true)
		data = p_ptr_sds(data, args);
