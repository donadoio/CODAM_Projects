...
/*   Updated: 2020/07/01 15:48:57 by idonado       ########   odam.nl         */
/*                                                                            */
/* ************************************************************************** */

#include "ft_printf.h"

t_data	p_hex_mwidth(const char *format, t_data data, va_list args, int cap)
{
	t_vars vars;
...
t_data	p_hex_dn(const char *format, t_data data, va_list args, int cap)
{
	t_vars vars;
...
t_data	p_hex_nd(const char *format, t_data data, va_list args, int cap)
{
	t_vars vars;
